...
public enum GrassSpecies implements RegistrySpecies
{
    ...
    GrassSpecies(SoundEvent sound, List<DayTime> times, List<KoppenClimateClassification> climates, float startYearFraction, float endYearFraction)
    {
