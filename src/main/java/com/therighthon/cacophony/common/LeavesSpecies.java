...
{
    REDWINGED_BLACKBIRD_WINTER(Sounds.REDWINGED_BLACKBIRD.get(), List.of(DayTime.DAY, DayTime.DAWN, DayTime.DUSK), List.of(KoppenClasses.CWA, KoppenClasses.CWB, KoppenClasses.CWC, KoppenClasses.CFA, KoppenClasses.CFB, KoppenClasses.CFC, KoppenClasses.CSA, KoppenClasses.CSB, KoppenClasses.CSC), 0, 4, 0, 1),
    ...
    LeavesSpecies(SoundEvent sound, List<DayTime> times, List<KoppenClasses> climates, int minForest, int maxForest, float startYearFraction, float endYearFraction)
    {
