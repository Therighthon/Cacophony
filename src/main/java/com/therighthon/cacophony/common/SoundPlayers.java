...
public class SoundPlayers
{
    ...
    public static void playPlantSound(BlockState state, Level level, BlockPos pos, RandomSource random)
    {
        ...
        else
        {
            ...
            if (rInt < 8 && (Helpers.isBlock(block, CacophonyTags.Blocks.FRESH_EMERGENT_PLANTS) || Helpers.isBlock(block, CacophonyTags.Blocks.FRESH_FLOATING_PLANTS)))
            {
            ...
            else if (rInt < 8 && (Helpers.isBlock(block, TFCTags.Blocks.HALOPHYTE)))
            {
