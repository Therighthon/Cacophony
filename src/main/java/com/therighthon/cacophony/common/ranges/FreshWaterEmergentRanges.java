...
public enum FreshWaterEmergentRanges implements RegistryRange
{
    ...
    PACIFIC_TREE_FROG(Sounds.PACIFIC_TREE_FROG.get(), List.of(DayTime.DUSK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.CSB, KoppenClimateClassification.CSC, KoppenClimateClassification.DSA), 0.25f, 0.75f, 60, 200),
    ...
    MOTORBIKE_FROG(Sounds.MOTORBIKE_FROG.get(), List.of(DayTime.DAY, DayTime.DAWN), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.CSA, KoppenClimateClassification.CSB), 0.0833333333333333f, 0.666666666666667f, 60, 80),
