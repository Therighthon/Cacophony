...
public enum FreshWaterEmergentRanges implements RegistryRange
{
    ...
    SPADEFOOT_TOAD(Sounds.SPADEFOOT_TOAD.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.BWK, KoppenClimateClassification.BSK), 0.166666666666667f, 0.833333333333333f, 60, 200, 0, 5, 6, 0.6f),
    SAHARA_FROG(Sounds.SAHARA_FROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.BWH, KoppenClimateClassification.BSH), 0f, 1f, 60, 200, 0, 5, 6, 0.6f),
    STRIPED_ROCKET_FROG(Sounds.STRIPED_ROCKET_FROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 0, 5, 6, 0.6f),
    BRAZILIAN_TORRENT_FROG(Sounds.BRAZILIAN_TORRENT_FROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS, KoppenClimateClassification.CWA, KoppenClimateClassification.CWB, KoppenClimateClassification.CFA), 0f, 1f, 80, 300, 0, 5, 6, 0.6f),
    BRAZILIAN_TORRENT_FROG_BREEDING(Sounds.BRAZILIAN_TORRENT_FROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DARK, DayTime.DUSK, DayTime.DAY, DayTime.DAWN), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS, KoppenClimateClassification.CWA, KoppenClimateClassification.CWB, KoppenClimateClassification.CFA), 0.25f, 0.75f, 80, 300, 0, 5, 6, 0.6f),
    PURPLE_FROG(Sounds.PURPLE_FROG.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AM), 0f, 1f, 70, 300, 0, 5, 6, 0.6f),
    MARSH_FROG(Sounds.MARSH_FROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DUSK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.CFB, KoppenClimateClassification.CFA, KoppenClimateClassification.CSA, KoppenClimateClassification.DFA, KoppenClimateClassification.DFB), 0.166666666666667f, 0.75f, 60, 300, 0, 5, 6, 0.6f),
    BANDED_BULLFROG(Sounds.BANDED_BULLFROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DUSK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.CWA, KoppenClimateClassification.CWB, KoppenClimateClassification.AM, KoppenClimateClassification.CWC), 0.25f, 0.833333333333333f, 60, 100, 0, 5, 6, 0.6f),
    BANDED_BULLFROG_AF(Sounds.BANDED_BULLFROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DUSK), List.of(Biome.Precipitation.RAIN, Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 100, 0, 5, 6, 0.6f),
    CENTRAL_COAST_STUBFOOT_TOAD(Sounds.CENTRAL_COAST_STUBFOOT_TOAD.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 120, 0, 5, 6, 0.6f),
    NORTHERN_CRICKET_FROG(Sounds.NORTHERN_CRICKET_FROG.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAY, DayTime.DUSK, DayTime.DAWN), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.DFA, KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC), 0.0833333333333333f, 0.833333333333333f, 60, 150, 0, 5, 6, 0.6f),
    ANKARAFA_SKELETON_FROG(Sounds.ANKARAFA_SKELETON_FROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AM), 0f, 1f, 60, 200, 0, 5, 6, 0.6f),
    ...
    WOOD_FROG(Sounds.WOOD_FROG.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.DFC, KoppenClimateClassification.DFD, KoppenClimateClassification.ET), 0.25f, 0.666666666666667f, 60, 200, 0, 5, 6, 0.6f),
    TALYSH_TOAD(Sounds.TALYSH_TOAD.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.BSK), 0f, 1f, 60, 200, 0, 5, 6, 0.6f),
    OLIVE_TOAD(Sounds.OLIVE_TOAD.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.RAIN, Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH), 0f, 1f, 60, 200, 0, 5, 6, 0.6f),
    CENTRAL_ASIAN_TOAD_COLD(Sounds.CENTRAL_ASIAN_TOAD.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.BWK, KoppenClimateClassification.BSK), 0.25f, 0.75f, 75, 200, 0, 5, 6, 0.6f),
    CENTRAL_ASIAN_TOAD_HOT(Sounds.CENTRAL_ASIAN_TOAD.get(), 1, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.BWH, KoppenClimateClassification.BSH), 0f, 1f, 75, 200, 0, 5, 6, 0.6f),
    ...
    STRIOLATED_BUNTING(Sounds.STRIOLATED_BUNTING.get(), 5, new Noise1D(42000, 10, 300), List.of(DayTime.DAY, DayTime.DUSK, DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH), 0f, 1f, 60, 200, 0, 5, 24, 0.3f),
    ...
    PALLAS_GRASSHOPPER_WARBLER_WINTER(Sounds.PALLAS_GRASSHOPPER_WARBLER.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0.833333333333333f, 0.333333333333333f, 60, 200, 0, 2, 24, 0.3f),
    ...
    COLLARED_KINGFISHER(Sounds.COLLARED_KINGFISHER.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 200, 0, 3, 24, 0.3f),
    ...
    SPOTTED_TOWHEE_WINTER(Sounds.SPOTTED_TOWHEE.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CSB, KoppenClimateClassification.CSA, KoppenClimateClassification.BSH), 0.666666666666667f, 0.25f, 60, 200, 0, 4, 24, 0.3f),
    ...
    BOREAL_CHORUS_FROG(Sounds.BOREAL_CHORUS_FROG.get(), 4, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFB, KoppenClimateClassification.DFC, KoppenClimateClassification.DFD), 0.25f, 0.75f, 60, 200, 0, 1, 6, 0.6f),
    CANADA_WARBLER_SUMMER(Sounds.CANADA_WARBLER.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFC, KoppenClimateClassification.DFB, KoppenClimateClassification.DFA), 0.416666666666667f, 0.666666666666667f, 60, 300, 2, 4, 24, 0.3f),
    CANADA_WARBLER_AUTUMN(Sounds.CANADA_WARBLER.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC), 0.666666666666667f, 0.833333333333333f, 60, 300, 2, 4, 24, 0.3f),
    CANADA_WARBLER_WINTER(Sounds.CANADA_WARBLER.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AM), 0.833333333333333f, 0.333333333333333f, 60, 300, 2, 4, 24, 0.3f),
    CANADA_WARBLER_SPRING(Sounds.CANADA_WARBLER.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC), 0.166666666666667f, 0.333333333333333f, 60, 300, 2, 4, 24, 0.3f),
    ...
    ORIENTAL_REED_WARBLER_WINTER(Sounds.ORIENTAL_REED_WARBLER.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0.833333333333333f, 0.333333333333333f, 60, 200, 0, 3, 24, 0.3f),
    ...
    ORIENTAL_SKYLARK_RESIDENT(Sounds.ORIENTAL_SKYLARK.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CWA, KoppenClimateClassification.CWB, KoppenClimateClassification.CWC), 0f, 1f, 60, 150, 0, 2, 24, 0.3f),
    ORIENTAL_SKYLARK_BREEDING(Sounds.ORIENTAL_SKYLARK.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.ET), 0.416666666666667f, 0.666666666666667f, 120, 320, 0, 2, 24, 0.3f),
    DJA_RIVER_SCRUB_WARBLER(Sounds.DJA_RIVER_SCRUB_WARBLER.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 0, 4, 24, 0.3f),
    BANDED_BANANA_FROG(Sounds.BANDED_BANANA_FROG.get(), 2, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AM, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 0, 2, 6, 0.6f),
    LOUISIANA_WATERTHRUSH_SUMMER(Sounds.LOUISIANA_WATERTHRUSH.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC), 0.25f, 0.75f, 60, 200, 2, 4, 24, 0.3f),
    LOUISIANA_WATERTHRUSH_WINTER(Sounds.LOUISIANA_WATERTHRUSH.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0.75f, 0.25f, 60, 200, 2, 4, 24, 0.3f),
    SCRUB_BLACKBIRD(Sounds.SCRUB_BLACKBIRD.get(), 3, new Noise1D(42000, 10, 300), List.of(DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH), 0f, 1f, 60, 200, 0, 3, 24, 0.3f),
