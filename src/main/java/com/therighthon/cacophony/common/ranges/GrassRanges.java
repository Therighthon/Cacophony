...
public enum GrassRanges implements RegistryRange
{
    ...
    BRONZY_SUNBIRD(Sounds.BRONZY_SUNBIRD.get(), 5, List.of(DayTime.DAY, DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 90, 320),
    STREAKY_SEEDEATER(Sounds.STREAKY_SEEDEATER.get(), 5, List.of(DayTime.DAY, DayTime.DUSK, DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 85, 320),
    GRACEFUL_PRINIA(Sounds.GRACEFUL_PRINIA.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH), 0f, 1f, 60, 120),
    GREATER_WHITETHROAT_SUMMER(Sounds.GREATER_WHITETHROAT.get(), 5, List.of(DayTime.DAY, DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BSK, KoppenClimateClassification.DFA, KoppenClimateClassification.CFC), 0.416666666666667f, 0.666666666666667f, 60, 320),
    GREATER_WHITETHROAT_AUTUMN(Sounds.GREATER_WHITETHROAT.get(), 5, List.of(DayTime.DAY, DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH, KoppenClimateClassification.BSH), 0.666666666666667f, 0.833333333333333f, 60, 320),
    GREATER_WHITETHROAT_WINTER(Sounds.GREATER_WHITETHROAT.get(), 5, List.of(DayTime.DAY, DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS, KoppenClimateClassification.BSH), 0.833333333333333f, 0.333333333333333f, 60, 320),
    GREATER_WHITETHROAT_SPRING(Sounds.GREATER_WHITETHROAT.get(), 5, List.of(DayTime.DAY, DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH, KoppenClimateClassification.BSH, KoppenClimateClassification.BWK), 0.166666666666667f, 0.333333333333333f, 60, 320),
    COMMON_MYNA(Sounds.COMMON_MYNA.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS, KoppenClimateClassification.AM, KoppenClimateClassification.CWA, KoppenClimateClassification.CWB), 0f, 1f, 60, 200),
    ASIAN_DESERT_WARBLER_SUMMER(Sounds.ASIAN_DESERT_WARBLER.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWK), 0.25f, 0.75f, 60, 200),
    ASIAN_DESERT_WARBLER_WINTER(Sounds.ASIAN_DESERT_WARBLER.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH), 0.75f, 0.25f, 60, 200),
    WHITE_WINGED_SNOWFINCH(Sounds.WHITE_WINGED_SNOWFINCH.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.ET), 0f, 1f, 120, 320),
    ASIAN_SHORT_TOED_LARK(Sounds.ASIAN_SHORT_TOED_LARK.get(), 5, List.of(DayTime.DUSK, DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWK, KoppenClimateClassification.BSK), 0f, 1f, 60, 200),
    PERUVIAN_MEADOWLARK(Sounds.PERUVIAN_MEADOWLARK.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH), 0f, 1f, 85, 300),
    MEADOW_BUNTING(Sounds.MEADOW_BUNTING.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DWA, KoppenClimateClassification.DWB, KoppenClimateClassification.CWC, KoppenClimateClassification.CWB, KoppenClimateClassification.CWA), 0f, 1f, 60, 200),
    LONG_TAILED_MEADOWLARK(Sounds.LONG_TAILED_MEADOWLARK.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWK, KoppenClimateClassification.BSK), 0f, 1f, 60, 200),
    PATAGONIAN_SIERRA_FINCH(Sounds.PATAGONIAN_SIERRA_FINCH.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DSD, KoppenClimateClassification.DWD, KoppenClimateClassification.DFD, KoppenClimateClassification.DWC, KoppenClimateClassification.DSC, KoppenClimateClassification.DFC), 0f, 1f, 110, 320),
    NORTHERN_CARMINE_BEE_EATER_BREEDING(Sounds.NORTHERN_CARMINE_BEE_EATER.get(), 5, List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BSH), 0f, 1f, 60, 200),
    NORTHERN_CARMINE_BEE_EATER_NONBREEDING(Sounds.NORTHERN_CARMINE_BEE_EATER.get(), 5, List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200),
    AFRICAN_PARADISE_FLYCATCHER(Sounds.AFRICAN_PARADISE_FLYCATCHER.get(), 5, List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200),
    EASTERN_MEADOWLARK(Sounds.EASTERN_MEADOWLARK.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFC, KoppenClimateClassification.CFB, KoppenClimateClassification.CFA, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200),
    BARN_SWALLOW_BREEDING(Sounds.BARN_SWALLOW.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC, KoppenClimateClassification.CSA, KoppenClimateClassification.CSB, KoppenClimateClassification.CSC, KoppenClimateClassification.CWA, KoppenClimateClassification.CWB, KoppenClimateClassification.CWC, KoppenClimateClassification.DSA, KoppenClimateClassification.DSB, KoppenClimateClassification.DSC, KoppenClimateClassification.DSD, KoppenClimateClassification.DWA, KoppenClimateClassification.DWB, KoppenClimateClassification.DWC, KoppenClimateClassification.DWD, KoppenClimateClassification.DFA, KoppenClimateClassification.DFB, KoppenClimateClassification.DFC, KoppenClimateClassification.DFD), 0.333333333333333f, 0.75f, 60, 200),
    BARN_SWALLOW_NONBREEDING(Sounds.BARN_SWALLOW.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC, KoppenClimateClassification.CSA, KoppenClimateClassification.CSB, KoppenClimateClassification.CSC, KoppenClimateClassification.CWA, KoppenClimateClassification.CWB, KoppenClimateClassification.CWC, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0.75f, 0.333333333333333f, 60, 200),
    YELLOW_HEADED_BLACKBIRD_BREEDING(Sounds.YELLOW_HEADED_BLACKBIRD.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWK, KoppenClimateClassification.BSK), 0.25f, 0.666666666666667f, 60, 200),
    YELLOW_HEADED_BLACKBIRD_NONBREEDING(Sounds.YELLOW_HEADED_BLACKBIRD.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH, KoppenClimateClassification.BSH), 0.666666666666667f, 0.25f, 60, 200),
    SONG_SPARROW_WINTER(Sounds.SONG_SPARROW.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC, KoppenClimateClassification.BSH, KoppenClimateClassification.DFA), 0.666666666666667f, 0.25f, 60, 200),
    SONG_SPARROW_SUMMER(Sounds.SONG_SPARROW.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFA, KoppenClimateClassification.DFB, KoppenClimateClassification.DFC, KoppenClimateClassification.BSK), 0.25f, 0.666666666666667f, 60, 200),
    RUFOUS_COLLARED_SPARROW(Sounds.RUFOUS_COLLARED_SPARROW.get(), 5, List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 80, 220),
    COMMON_STARLING_BREEDING(Sounds.COMMON_STARLING.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.ET, KoppenClimateClassification.DFC, KoppenClimateClassification.DFD, KoppenClimateClassification.DSC, KoppenClimateClassification.DSD), 0.333333333333333f, 0.666666666666667f, 60, 200),
    COMMON_STARLING_RESIDENT(Sounds.COMMON_STARLING.get(), 5, List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFA, KoppenClimateClassification.DFB, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC, KoppenClimateClassification.CSB, KoppenClimateClassification.CSC, KoppenClimateClassification.DSA, KoppenClimateClassification.DSB), 0f, 1f, 60, 200),
    SNOW_BUNTING_SUMMER(Sounds.SNOW_BUNTING.get(), 5, List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.ET, KoppenClimateClassification.EF, KoppenClimateClassification.DFC, KoppenClimateClassification.DFD, KoppenClimateClassification.DWC, KoppenClimateClassification.DWD), 0.333333333333333f, 0.75f, 60, 200),
    SNOW_BUNTING_WINTER(Sounds.SNOW_BUNTING.get(), 5, List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFA, KoppenClimateClassification.DFB, KoppenClimateClassification.DFC, KoppenClimateClassification.DFD, KoppenClimateClassification.DWA, KoppenClimateClassification.DWB, KoppenClimateClassification.DWC, KoppenClimateClassification.DWD), 0.75f, 0.333333333333333f, 60, 200);
