...
public enum GrassRanges implements RegistryRange
{
    ...
    TWO_COLORED_OVAL_FROG(Sounds.TWO_COLORED_OVAL_FROG.get(), List.of(DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC), 0f, 1f, 60, 200);
