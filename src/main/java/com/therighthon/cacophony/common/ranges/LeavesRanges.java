...
public enum LeavesRanges implements RegistryRange
{
    ...
    MALABAR_GLIDING_FROG(Sounds.MALABAR_GLIDING_FROG.get(), 1, List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.RAIN, Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AM), 0.25f, 0.75f, 100, 320),
