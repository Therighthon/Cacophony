...
public enum LeavesRanges implements RegistryRange
{
    ...
    RESPLENDENT_QUETZAL(Sounds.RESPLENDENT_QUETZAL.get(), 3, new Noise1D(69001, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.CWA), 0f, 1f, 90, 320, 0, 5, 18, 0.5f),
    ...
    WHITE_CHEEKED_BARBET(Sounds.WHITE_CHEEKED_BARBET.get(), 3, new Noise1D(69005, 10, 300), List.of(DayTime.DAY, DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AM), 0.916666666666667f, 0.416666666666667f, 100, 300, 0, 5, 18, 0.5f),
    ...
    GREAT_KISKADEE(Sounds.GREAT_KISKADEE.get(), 3, new Noise1D(69016, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 0, 5, 18, 0.5f),
    THRUSH_NIGHTINGALE_SUMMER(Sounds.THRUSH_NIGHTINGALE.get(), 3, new Noise1D(69017, 10, 300), List.of(DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFB, KoppenClimateClassification.DFA), 0.25f, 0.75f, 60, 200, 0, 5, 18, 0.5f),
    THRUSH_NIGHTINGALE_WINTER(Sounds.THRUSH_NIGHTINGALE.get(), 3, new Noise1D(69018, 10, 300), List.of(DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BSH), 0.75f, 0.416666666666667f, 60, 200, 0, 5, 18, 0.5f),
    ...
    SNOWY_OWL_SUMMER(Sounds.SNOWY_OWL.get(), 4, new Noise1D(69026, 10, 300), List.of(DayTime.DARK, DayTime.DAY), List.of(Biome.Precipitation.NONE, Biome.Precipitation.SNOW), List.of(KoppenClimateClassification.ET, KoppenClimateClassification.EF), 0.25f, 0.75f, 60, 180, 0, 5, 18, 0.5f),
    ...
    COMMON_CUCKOO_WINTER(Sounds.COMMON_CUCKOO.get(), 3, new Noise1D(69029, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BSH, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0.75f, 0.416666666666667f, 60, 200, 0, 5, 18, 0.5f),
    BLACK_AND_WHITE_CASQUED_HORNBILL(Sounds.BLACK_AND_WHITE_CASQUED_HORNBILL.get(), 3, new Noise1D(69030, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 100, 0, 5, 18, 0.5f),
    GREEN_BACKED_CAMAROPTERA(Sounds.GREEN_BACKED_CAMAROPTERA.get(), 3, new Noise1D(69031, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS, KoppenClimateClassification.AF, KoppenClimateClassification.BSH), 0f, 1f, 60, 200, 0, 5, 18, 0.5f),
    ...
    ORIENTAL_BAY_OWL(Sounds.ORIENTAL_BAY_OWL.get(), 5, new Noise1D(69033, 10, 300), List.of(DayTime.DARK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 200, 0, 5, 18, 0.5f),
    COPPERSMITH_BARBET(Sounds.COPPERSMITH_BARBET.get(), 3, new Noise1D(69034, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AM, KoppenClimateClassification.AF), 0f, 1f, 60, 200, 0, 5, 18, 0.5f),
    LARGE_FROGMOUTH(Sounds.LARGE_FROGMOUTH.get(), 3, new Noise1D(69035, 10, 300), List.of(DayTime.DARK, DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 200, 3, 4, 18, 0.5f),
    BOLD_STRIPED_TIT_BABBLER(Sounds.BOLD_STRIPED_TIT_BABBLER.get(), 3, new Noise1D(69036, 10, 300), List.of(DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 200, 0, 5, 18, 0.5f),
    BLUE_EARED_BARBET(Sounds.BLUE_EARED_BARBET.get(), 3, new Noise1D(69037, 10, 300), List.of(DayTime.DAY, DayTime.DAWN), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 320, 1, 2, 18, 0.5f),
    RUFOUS_TAILED_TAILORBIRD(Sounds.RUFOUS_TAILED_TAILORBIRD.get(), 3, new Noise1D(69038, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 200, 2, 4, 18, 0.5f),
    YELLOW_VENTED_BULBUL(Sounds.YELLOW_VENTED_BULBUL.get(), 3, new Noise1D(69039, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 200, 1, 2, 18, 0.5f),
    PLAINTIVE_CUCKOO(Sounds.PLAINTIVE_CUCKOO.get(), 3, new Noise1D(69040, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 200, 0, 3, 18, 0.5f),
    PLAINTIVE_CUCKOO_BREEDING(Sounds.PLAINTIVE_CUCKOO.get(), 3, new Noise1D(69041, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CWA), 0.333333333333333f, 0.583333333333333f, 60, 200, 0, 3, 18, 0.5f),
    WILSONS_BIRD_OF_PARADISE(Sounds.WILSONS_BIRD_OF_PARADISE.get(), 3, new Noise1D(69042, 10, 300), List.of(DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AM), 0f, 1f, 90, 250, 4, 4, 18, 0.5f),
    PALM_COCKATOO(Sounds.PALM_COCKATOO.get(), 3, new Noise1D(69043, 10, 300), List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AM), 0.0833333333333333f, 1f, 60, 200, 2, 4, 18, 0.5f),
    BLUE_WINGED_KOOKABURRA(Sounds.BLUE_WINGED_KOOKABURRA.get(), 3, new Noise1D(69044, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 4, 18, 0.5f),
    SUPERB_PITTA(Sounds.SUPERB_PITTA.get(), 3, new Noise1D(69045, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 200, 3, 4, 18, 0.5f),
    PAPUAN_KING_PARROT(Sounds.PAPUAN_KING_PARROT.get(), 3, new Noise1D(69046, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 100, 240, 2, 4, 18, 0.5f),
    MAGNIFICENT_BIRD_OF_PARADISE(Sounds.MAGNIFICENT_BIRD_OF_PARADISE.get(), 3, new Noise1D(69047, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 90, 290, 2, 4, 18, 0.5f),
    ...
    RAGGIANA_BIRD_OF_PARADISE(Sounds.RAGGIANA_BIRD_OF_PARADISE.get(), 3, new Noise1D(69057, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 200, 3, 4, 18, 0.5f),
    TROPICAL_MOCKINGBIRD(Sounds.TROPICAL_MOCKINGBIRD.get(), 3, new Noise1D(69058, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 4, 18, 0.5f),
    LEWIS_WOODPECKER_SUMMER(Sounds.LEWIS_WOODPECKER.get(), 3, new Noise1D(69059, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CSC, KoppenClimateClassification.DSA, KoppenClimateClassification.DSB, KoppenClimateClassification.BSK), 0.25f, 0.75f, 60, 200, 3, 4, 18, 0.5f),
    ...
    YELLOW_BACKED_ORIOLE(Sounds.YELLOW_BACKED_ORIOLE.get(), 5, new Noise1D(69062, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AS, KoppenClimateClassification.AW), 0f, 1f, 60, 100, 2, 4, 18, 0.5f),
    KEEL_BILLED_TOUCAN(Sounds.KEEL_BILLED_TOUCAN.get(), 5, new Noise1D(69063, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 3, 4, 18, 0.5f),
    YELLOW_THROATED_TOUCAN(Sounds.YELLOW_THROATED_TOUCAN.get(), 5, new Noise1D(69064, 10, 300), List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 110, 4, 4, 18, 0.5f),
    CRIMSON_BACKED_TANAGER(Sounds.CRIMSON_BACKED_TANAGER.get(), 5, new Noise1D(69065, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 4, 18, 0.5f),
    SLATE_COLORED_GROSBEAK(Sounds.SLATE_COLORED_GROSBEAK.get(), 5, new Noise1D(69066, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 150, 2, 4, 18, 0.5f),
    SPECTACLED_OWL(Sounds.SPECTACLED_OWL.get(), 5, new Noise1D(69067, 10, 300), List.of(DayTime.DARK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 200, 4, 4, 18, 0.5f),
    COLLARED_TROGON(Sounds.COLLARED_TROGON.get(), 8, new Noise1D(69068, 10, 300), List.of(DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.CWA), 0f, 1f, 60, 200, 3, 4, 18, 0.5f),
    PALE_BREASTED_THRUSH(Sounds.PALE_BREASTED_THRUSH.get(), 5, new Noise1D(69069, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 4, 18, 0.5f),
    ...
    GREAT_ANTSHRIKE(Sounds.GREAT_ANTSHRIKE.get(), 5, new Noise1D(69071, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 3, 18, 0.5f),
    RED_LORED_AMAZON(Sounds.RED_LORED_AMAZON.get(), 5, new Noise1D(69072, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 150, 3, 4, 18, 0.5f),
    MONTEZUMA_OROPENDOLA(Sounds.MONTEZUMA_OROPENDOLA.get(), 5, new Noise1D(69073, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF), 0f, 1f, 60, 200, 2, 4, 18, 0.5f),
    ...
    EASTERN_WOOD_PEWEE_WINTER(Sounds.EASTERN_WOOD_PEWEE.get(), 5, new Noise1D(69077, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE, Biome.Precipitation.RAIN), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0.833333333333333f, 0.333333333333333f, 60, 200, 0, 4, 18, 0.5f),
    ...
    WOOD_THRUSH_SUMMER(Sounds.WOOD_THRUSH.get(), 5, new Noise1D(69079, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFC, KoppenClimateClassification.DFA, KoppenClimateClassification.DFB), 0.333333333333333f, 0.75f, 60, 200, 2, 3, 18, 0.5f),
    WOOD_THRUSH_WINTER(Sounds.WOOD_THRUSH.get(), 5, new Noise1D(69080, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0.75f, 0.333333333333333f, 60, 200, 2, 3, 18, 0.5f),
    ...
    FOX_SPARROW_SUMMER(Sounds.FOX_SPARROW.get(), 5, new Noise1D(69083, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.ET, KoppenClimateClassification.DFD), 0.416666666666667f, 0.666666666666667f, 60, 200, 0, 2, 18, 0.5f),
    FOX_SPARROW_AUTUMN(Sounds.FOX_SPARROW.get(), 5, new Noise1D(69084, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFA, KoppenClimateClassification.DFB, KoppenClimateClassification.DFC), 0.666666666666667f, 0.833333333333333f, 60, 200, 0, 4, 18, 0.5f),
    FOX_SPARROW_WINTER(Sounds.FOX_SPARROW.get(), 5, new Noise1D(69085, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC), 0.833333333333333f, 0.333333333333333f, 60, 200, 0, 2, 18, 0.5f),
    FOX_SPARROW_SPRING(Sounds.FOX_SPARROW.get(), 5, new Noise1D(69086, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DFA, KoppenClimateClassification.DFB, KoppenClimateClassification.DFC), 0.166666666666667f, 0.333333333333333f, 60, 200, 0, 4, 18, 0.5f),
    ...
    BROWN_BULBUL_SUMMER(Sounds.BROWN_BULBUL.get(), 5, new Noise1D(69095, 10, 300), List.of(DayTime.DAY, DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DWA, KoppenClimateClassification.DWB), 0.25f, 0.75f, 60, 200, 2, 4, 18, 0.5f),
    BROWN_BULBUL_WINTER(Sounds.BROWN_BULBUL.get(), 5, new Noise1D(69096, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CWC, KoppenClimateClassification.CWB), 0.75f, 0.25f, 60, 200, 2, 4, 18, 0.5f),
    JAPANESE_BUSH_WARBLER_RESIDENT(Sounds.JAPANESE_BUSH_WARBLER.get(), 5, new Noise1D(69097, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CWC, KoppenClimateClassification.DWA), 0f, 1f, 60, 200, 0, 4, 18, 0.5f),
    JAPANESE_BUSH_WARBLER_BREEDING(Sounds.JAPANESE_BUSH_WARBLER.get(), 5, new Noise1D(69098, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DWB), 0.333333333333333f, 0.75f, 60, 200, 0, 4, 18, 0.5f),
    AZURE_WINGED_MAGPIE(Sounds.AZURE_WINGED_MAGPIE.get(), 5, new Noise1D(69099, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DWB, KoppenClimateClassification.DWC, KoppenClimateClassification.DWA), 0f, 1f, 60, 200, 1, 4, 18, 0.5f),
    TAIWAN_BARBET(Sounds.TAIWAN_BARBET.get(), 5, new Noise1D(69100, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CWA, KoppenClimateClassification.CWB), 0f, 1f, 60, 200, 2, 4, 18, 0.5f),
    ASIAN_KOEL(Sounds.ASIAN_KOEL.get(), 5, new Noise1D(69101, 10, 300), List.of(DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS, KoppenClimateClassification.AM, KoppenClimateClassification.AF, KoppenClimateClassification.CWA, KoppenClimateClassification.CWB, KoppenClimateClassification.CWC), 0f, 1f, 60, 280, 0, 4, 18, 0.5f),
    BEIJING_BABBLER(Sounds.BEIJING_BABBLER.get(), 5, new Noise1D(69102, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.DWA, KoppenClimateClassification.DWB), 0f, 1f, 60, 200, 0, 4, 18, 0.5f),
    WHISTLING_CISTICOLA(Sounds.WHISTLING_CISTICOLA.get(), 5, new Noise1D(69103, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 3, 18, 0.5f),
    CHALK_BROWED_MOCKINGBIRD(Sounds.CHALK_BROWED_MOCKINGBIRD.get(), 5, new Noise1D(69104, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 2, 18, 0.5f),
    LAUGHING_KOOKABURRA(Sounds.LAUGHING_KOOKABURRA.get(), 12, new Noise1D(69105, 10, 300), List.of(DayTime.DAWN, DayTime.DAY, DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BSH, KoppenClimateClassification.CFA), 0f, 1f, 60, 200, 1, 4, 18, 0.5f),
    ...
    YELLOW_BILLED_TURACO(Sounds.YELLOW_BILLED_TURACO.get(), 5, new Noise1D(69107, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 2, 4, 18, 0.5f),
    TAMBOURINE_DOVE(Sounds.TAMBOURINE_DOVE.get(), 5, new Noise1D(69108, 10, 300), List.of(DayTime.DUSK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 3, 4, 18, 0.5f),
    SUPERB_LYREBIRD(Sounds.SUPERB_LYREBIRD.get(), 12, new Noise1D(69109, 10, 300), List.of(DayTime.DAWN, DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BSH, KoppenClimateClassification.CFA, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 1, 4, 18, 0.5f),
    WILLIE_WAGTAIL(Sounds.WILLIE_WAGTAIL.get(), 5, new Noise1D(69110, 10, 300), List.of(DayTime.DUSK, DayTime.DARK, DayTime.DAWN), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.BWH, KoppenClimateClassification.BWK), 0f, 1f, 60, 200, 1, 3, 18, 0.5f),
    GREEN_IMPERIAL_PIGEON(Sounds.GREEN_IMPERIAL_PIGEON.get(), 5, new Noise1D(69111, 10, 300), List.of(DayTime.DAWN, DayTime.DUSK, DayTime.DARK), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM), 0f, 1f, 60, 200, 3, 4, 18, 0.5f),
    ...
    BRAZILIAN_CICADA(Sounds.BRAZILIAN_CICADA.get(), 20, new Noise1D(69113, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 2, 4, 0, 0.2f),
    CROATIAN_CICADA(Sounds.CROATIAN_CICADA.get(), 24, new Noise1D(69114, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CSA, KoppenClimateClassification.CSB, KoppenClimateClassification.CSC), 0.5f, 0.666666666666667f, 60, 200, 2, 4, 0, 0.2f),
    CICADA(Sounds.CICADA.get(), 16, new Noise1D(69115, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.CFA, KoppenClimateClassification.CFB, KoppenClimateClassification.CFC, KoppenClimateClassification.DFA), 0.5f, 0.666666666666667f, 60, 200, 2, 4, 0, 0.2f),
    CAMBODIAN_CICADA(Sounds.CAMBODIAN_CICADA.get(), 20, new Noise1D(69116, 10, 300), List.of(DayTime.DAY), List.of(Biome.Precipitation.NONE), List.of(KoppenClimateClassification.AF, KoppenClimateClassification.AM, KoppenClimateClassification.AW, KoppenClimateClassification.AS), 0f, 1f, 60, 200, 2, 4, 0, 0.2f);
